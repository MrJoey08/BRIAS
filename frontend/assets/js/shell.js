  ...
  function _drawerHTML() {
    const nav = [
      ...
      },
      {
        ...
        icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,170,150,.65)" stroke-width="1.8" stroke-linecap="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>`,
      },
      {
        id: 'planner',
        href: 'planner.html',
        ...
        icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,170,150,.65)" stroke-width="1.8" stroke-linecap="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>`,
      },
      {
        id: 'mindspace',
        href: null,
        ...
        soon: true,
        icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="rgba(255,170,150,.65)" stroke-width="1.8" stroke-linecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>`,
      },
    ];
  ...
  <div class="drawer-panel">
    ...
    <div class="drawer-footer">
      ...
      <button class="drawer-settings-btn" onclick="SHELL.openSettings();SHELL.closeDrawer();" title="Settings">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,170,150,.65)" stroke-width="1.5" stroke-linecap="round">
...
<div class="settings-overlay" id="shellSettings">
  <div class="settings-header">
    ...
    <button class="settings-close-btn" onclick="SHELL.closeSettings()">
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(255,170,150,.65)" stroke-width="2.5" stroke-linecap="round">
