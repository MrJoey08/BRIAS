  ...
  function _drawerHTML() {
    const nav = [
      ...
      },
      {
        ...
        icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round">
          <defs><linearGradient id="shellNgJ" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#e8764a"/><stop offset="100%" stop-color="#d44a7a"/></linearGradient></defs>
          <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" stroke="url(#shellNgJ)"/>
          <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" stroke="url(#shellNgJ)"/>
        </svg>`,
      },
      {
        id: 'planner',
        ...
        icon: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round">
          <defs><linearGradient id="shellNgP" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#e8764a"/><stop offset="100%" stop-color="#d44a7a"/></linearGradient></defs>
          <rect x="3" y="4" width="18" height="18" rx="2" stroke="url(#shellNgP)"/>
          <path d="M16 2L16 6" stroke="url(#shellNgP)"/>
          <path d="M8 2L8 6" stroke="url(#shellNgP)"/>
          <path d="M3 10L21 10" stroke="url(#shellNgP)"/>
        </svg>`,
      },
      {
        id: 'mindspace',
    ...
    <div class="drawer-footer">
      ...
      <button class="drawer-settings-btn" onclick="SHELL.openSettings();SHELL.closeDrawer();" title="Settings">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke-linecap="round">
          <defs><linearGradient id="shellNgS" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#e8764a"/><stop offset="100%" stop-color="#d44a7a"/></linearGradient></defs>
  ...
  <div class="settings-header">
    ...
    <button class="settings-close-btn" onclick="SHELL.closeSettings()">
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke-width="2.5" stroke-linecap="round">
        ...
        <path d="M18 6L6 18" stroke="url(#shellNgX)"/><path d="M6 6L18 18" stroke="url(#shellNgX)"/>
      </svg>
    </button>
  </div>
