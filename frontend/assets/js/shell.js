...
<div class="pmodal" id="shellProfileModal">
  ...
  const _tabs = [
    ...
    () => `
      ...
      <div class="sub-cards">
        ...
        <div class="sub-card"><div class="sub-card-name">Connected</div><div class="sub-card-price">€23— <span>/ month</span></div><ul class="sub-card-perks"><li>Help shape who BRIAS becomes</li><li>Early access to what's new, help refine it before it reaches the people who need it most.</li><li>Priority access when it's busy</li><li>Almost no limits, experience every moment together</li></ul></div>
      </div>`,
    // 2 — Permissions
    () => `
      <div class="s-section">
  ...
  <p class="s-row-label" style="margin-top:12px;">test___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________</p>`,
  ];
